...
<div class="container" style="margin-top: 50px; width: 500px">
  <a href="cadastrarFornecedores.jsp">Cadastrar fornecedores</a>
  <table class="table">
    <thead>
    ...
    <c:forEach var="f" items="${Fornecedores}">
      <tr style="text-align: center">
        <td>${f.nome}</td>
        <td><a href="http://localhost:8080/controleEstoque/fornecedor-controller?opcao=editar&&id=${f.id}">Editar</a></td>
        <td><a href="http://localhost:8080/controleEstoque/fornecedor-controller?opcao=excluir&&id=${f.id}">Excluir</a></td>
      </tr>
    </c:forEach>
    </tbody>
  </table>
